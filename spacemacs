...
you should place you code here."
  ...
  (defun my-setup-indent (n)
    ...
    (setq typescript-indent-level n
          typescript-expr-indent-offset n) ; typescript
  ...
  (setq tern-command '("node" "/Users/jamie/.nvm/versions/node/v5.8.0/bin/tern"))
)
